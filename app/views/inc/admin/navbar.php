        ...
        <div class="col-auto col-md-2 col-xl-1 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item">
                        <a href="<?php echo URLROOT; ?>/admin/dashboard" class="nav-link align-middle px-0">
                    ...
                    <li>
                        <a href="<?php echo URLROOT; ?>/products" class="nav-link px-0 align-middle">
                ...
                <div class="dropdown pb-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                        ...
                        <li><a class="dropdown-item" href="<?php echo URLROOT; ?>/admin/logout">Sign out</a></li>
                    </ul>
                </div>
            </div>
        </div>
